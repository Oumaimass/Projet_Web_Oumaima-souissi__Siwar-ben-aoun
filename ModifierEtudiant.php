    ...
    <main role="main">
        <div class="jumbotron">
            <div class="container">
                ...
                <p>Cliquer sur le bouton de Modifier devant chaque Etudiant que vous Souhaitez le Modifier !</p><br>
                    ...
                    <table class="table table-striped table-hover">
                        ...
                        <?php while ($etu = $res->fetch(PDO::FETCH_ASSOC)) { ?>
                            <tr>
                                ...
                                <td><a href="EditEtudiant.php?cin=<?php echo ($etu['cin']) ?>">Modifier</a></td>
                            </tr>
