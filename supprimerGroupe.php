...
<div class="container">
 <form id="myform" method="POST" action="">
     ...
     <!--Bouton supprimer-->
   <button type="submit" class="btn btn-primary btn-block" onclick="supprimerr()">supprimer</button><br><br>
...
include("connexion.php");
         ...
         if(count($tab)>0){
         $req="delete from etudiant where classe='$classe'";
         $reponse = $pdo->exec($req) or die("error");
         $req="delete from Groupe where nom_groupe='$classe'";
         $reponse = $pdo->exec($req) or die("error");
         $erreur ="OK"; } 
         else {
            $erreur="NOT OK";
         ...
         if ( $erreur =="OK")
        { echo '<font color="	limegreen">La suppression du groupe a été bien effectué</font>';}
        else {
...
<br><br><a href="supprimerGroupe.php"> Supprimer un autre groupe</a>  
</div>  
</main>

<footer class="container">
<br><br> <br><br> <p>&copy;ENICAR 2021-2022</p>
  </footer>
