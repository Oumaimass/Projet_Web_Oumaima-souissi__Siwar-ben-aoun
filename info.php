...
$req = "select * from Groupe WHERE nom_groupe like 'INFO%'";
...
function aller(){ 
  ...
  document.location.href="inf.php?classe="+saisie;}</script>
    ...
    <main role="main">
        <div class="jumbotron">
            <div class="container">
                <h1 class="display-4">afficher tous les groupes de spécialité "informatique" </h1>
                    ...
                    <table class="table table-striped table-hover">
                        ...
                        <?php while ($grp = $res->fetch(PDO::FETCH_ASSOC)) { ?>
                            <tr>
                                ...
                                <td><a href="inffo.php?nom_groupe=<?php echo ($grp['nom_groupe']) ?>">afficher</a></td>
                            </tr>
