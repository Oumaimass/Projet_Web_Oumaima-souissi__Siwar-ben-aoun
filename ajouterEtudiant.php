...
<div class="container">
 <form id="myForm" method="POST"  >
    ...
    <div class="form-group">
     ...
     <textarea id="adresse" name="adresse" rows="10" cols="10" class="form-control" required>
     </textarea>
    </div>
     <!--Bouton Ajouter-->
...
include("connexion.php");
         ...
         $tab=$sel->fetchAll();
         if(count($tab)>0)
         echo '<font color="limegreen"> Etudiant existant</font>';
         else{
            $req="insert into etudiant values ($cin,'$email',md5('$pwd'),md5('$cpwd'),'$nom','$prenom','$adresse','$classe')";
            $reponse = $pdo->exec($req) or die("error");
            echo '<font color="limegreen">Etudiant ajouté</font>';
         }  }
