...
$req = "select * from Groupe WHERE nom_groupe like 'INFO3%'";
...
function aller(){ 
  ...
  document.location.href="inf.php?classe="+saisie;}</script>
    ...
    <main role="main">
        <div class="jumbotron">
            <div class="container">
                <h1 class="display-4">afficher les groupes de INFO-3 </h1>
                    ...
                    <table class="table table-striped table-hover">
                        ...
                        <?php while ($grp = $res->fetch(PDO::FETCH_ASSOC)) { ?>
                            <tr>
                                ...
                                <td><a href="inffo3.php?nom_groupe=<?php echo ($grp['nom_groupe']) ?>">afficher</a></td>
                            </tr>
